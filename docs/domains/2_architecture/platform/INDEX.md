...
title: Platform Domain Documentation
description: Core platform services covering authentication, users, billing, notifications, streaming, marketplace, and social features.
keywords: platform, services, auth, users, billing, notifications, streaming, marketplace, social, index
...
- **[Execution](../execution/INDEX.md)**: Order routing and execution
