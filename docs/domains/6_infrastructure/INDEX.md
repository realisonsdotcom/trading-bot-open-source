...
- See [Operations Domain](../3_operations/INDEX.md) for deployment guides
...
**Related Documentation**:
- See [Observability Domain](../3_operations/observability/README.md) for monitoring setup
- See [Metrics Domain](../3_operations/metrics/README.md) for custom metrics
...
- **[3_operations](../3_operations/INDEX.md)**: Deployment guides and operational procedures
- **[4_platform](../4_platform/INDEX.md)**: Platform services that use this infrastructure
